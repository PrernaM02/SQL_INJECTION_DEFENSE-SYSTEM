# SQL_INJECTION_DEFENSE-SYSTEM🔐 SQL Injection Defense System

Machine Learning-Based Detection using TF-IDF + XGBoost

📌 Overview
This project focuses on detecting and preventing SQL Injection (SQLi) attacks using a machine learning approach. It leverages TF-IDF vectorization and the XGBoost classifier to identify malicious SQL queries with high accuracy.
